...
checks = {
  ...
  'V429 cache/query markers current': 'runtime/css/promptcraft.css?v=429&patch=443' in idx and 'runtime/js/promptcraft.bundle.js?v=429&amp;patch=443&amp;receiver=82' in idx,
}
