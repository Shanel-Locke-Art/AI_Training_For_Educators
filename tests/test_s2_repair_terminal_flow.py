...
checks = {
  ...
  'V429 cache/query markers current': f'runtime/css/promptcraft.css?v=429&patch={_patch}' in idx and f'runtime/js/promptcraft.bundle.js?v=429&amp;patch={_patch}&amp;receiver=85' in idx,
}
