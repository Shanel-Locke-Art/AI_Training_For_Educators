...
checks={
 ...
 'print includes GFC text affiliation': 'Great Falls College Montana State University' in terminal,
 'print has no missing GFC image dependency': 'great-falls-college-logo.jpg' not in terminal,
