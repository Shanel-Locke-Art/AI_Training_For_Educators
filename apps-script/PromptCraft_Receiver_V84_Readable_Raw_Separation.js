/**
 * PromptCraft Google Apps Script receiver — READABLE/RAW SEPARATION V84
 *
 * Live job:
 ...
 *
 * V84 preserves every V83 tab and V121 raw column, adds lossless raw payload
...
const PROMPTCRAFT_RECEIVER_VERSION = 'V84';
...
const PromptCraftReceiver = (() => {
  ...
  function rebuildResearchGuideView_() {
    ...
    const coding = [
      ...
      ['Canvas course design','02 - S1 Engagement (legacy tab name)','Content Avalanche evidence, repair reasoning, and instructor verification.','Use the verified S1 roadmap label in readable projections.'],
    ...
    const guide = [
      ...
      ['02 - S1 Engagement','Current S1: The Content Avalanche','Canvas evidence and repair analysis','Tab name is retained for spreadsheet compatibility.'],
  ...
  function initializeWorkbookNow() {
    const consolidated = { skipped: true, reason: 'V84 preserves all existing tabs; migrate only on a recovery copy.' };
    ensureRawArchiveHeaders_(getSheet_(SHEET_RAW_ARCHIVE));
