...
QUICK_CHECKS = (
    ...
    ("Patch 530 shared analysis presentation model", [sys.executable, "tests/test_shared_analysis_presentation_530.py"]),
    ("Patch 531 displayed Scenario 3 analysis migration", [sys.executable, "tests/test_s3_shared_analysis_migration_531.py"]),
    ...
    ("Patch 539 browser contract alignment", [sys.executable, "tests/test_browser_contract_alignment_539.py"]),
    ("Patch 540 internal scenario screenshot inventory", [sys.executable, "tests/test_internal_scenario_capture_540.py"]),
