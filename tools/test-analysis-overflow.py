...
def main() -> int:
    ...
    with sync_playwright() as playwright:
        ...
        for viewport, (width, height) in VIEWPORTS.items():
            ...
            page.evaluate("showClaudeConsultOverlay('Long-content regression')")
            ...
            page.evaluate("""() => {
              ...
              showBabbageTerminalReport({
                reportHTML: buildClaudeAnalysisHTML(feedback, false, ''),
            ...
            page.evaluate("showClaudeConsultOverlay('Long-content S2 regression')")
            page.wait_for_timeout(100)
            page.evaluate("""() => {
