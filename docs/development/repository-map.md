...
Current identifiers: application `PROMPTCRAFT_V429`, patch `575`, research `V121`, receiver `V85`, asset manifest `v150`.
...
| Receiver source | `apps-script/PromptCraft_Receiver_V85_Start_With_Learning.js` |
