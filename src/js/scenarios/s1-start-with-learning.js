...
pcRegisterUIActions({
  ...
  's1-learning-use-diagnosis': () => pcUseS1Diagnosis(),
  ...
  's1-learning-revise-before-guide': () => pcReviseBeforeS1Guide(),
  ...
  's1-learning-show-revised-overview': () => pcRenderS1RevisedModuleOverview(),
